...
python \
      ...
      --workers 32 \
      --pretrained $HOME2/scratch/ensem_pt_checkpoints/ep100_base_splits/base-IN1k-e100-split${split}-checkpoint_epoch99.pth \
      ...
      --exp-id ft_base_e100_split${split}_cos_lr${lr}_bs256 \
      --batch-size 256 \
      --nodes 2 \
      --ngpus-per-node 4 \
