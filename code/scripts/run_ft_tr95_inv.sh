...
python \
      ...
      --workers 32 \
      --pretrained $HOME2/scratch/ensem_pt_checkpoints/rotinv-IN1k-e400-tr95-seed${seed}-checkpoint_epoch400.pth \
      ...
      --exp-id tr95e400_ft_inv${seed}_cos_lr${lr}_bs256 \
      --batch-size 256 \
      --nodes 2 \
      --ngpus-per-node 4 \
      --training-ratio 0.95
