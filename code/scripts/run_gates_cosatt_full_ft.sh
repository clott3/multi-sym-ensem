...
python \
      ...
      --workers 32 \
      --pretrained $HOME2/scratch/ensem_ssl/dist_models/ft_baseR_cos_lr0.003_bs256/checkpoint_best.pth $HOME2/scratch/ensem_ssl/dist_models/ft_eqR_cos_lr0.003_bs256/checkpoint_best.pth $HOME2/scratch/ensem_ssl/dist_models/ft_inv_cos_lr0.003_bs256/checkpoint_best.pth \
      ...
      --exp-id INft_gate_rn50_cosatt_lmbd${lmbd}_lr${lr}_bs256_ep${ep}_wd${wd} \
      --batch-size 256 \
      --nodes 2 \
      --ngpus-per-node 4 \
      --epochs ${ep} \
