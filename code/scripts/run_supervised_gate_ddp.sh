...
port=$(($RANDOM+10000))
python main_supervised_gate.py /data/scratch/swhan/data/imagenet/ -a mlp --dataset imagenet \
    --use-features --hidden-dim 1024 512 --num-classes 3 -b 256 --lr 0.1 --sampling-method classwise \
